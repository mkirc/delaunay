...
def delaunay(m, start, end, leftEdge=None, rightEdge=None, rows=None):
    ...
    It returns the outermost edges [leftEdge, rightEdge] of the convex hull it builds
    while connecting points to form a delaunay triangulation.
    """
